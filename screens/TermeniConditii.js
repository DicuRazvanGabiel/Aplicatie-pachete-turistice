...
const TermeniConditii = ({navigation}) => {
    ...
    fetchAdvantages = async () => {
      const response = await fetch(`https://natbiot-travelling-d0a35.firebaseio.com/flamelink/environments/production/content/termeniSiConditii/en-US/1582305126984/${lang}.json`);
